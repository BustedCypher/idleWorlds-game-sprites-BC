...
def verify(root:Path):
 ...
 ok=len(items)==4458 and len(gear)==3188 and len(other)==1270 and len(a['gear_records'])==1152 and len(a['item_cells'])==477 and ups=={'1':510,'2':510,'3':510,'4':510} and len(m['chunks'])==17 and not(gm or unexpected or static or errors or mismatches or unhashed) and all(checks.values())
